...
function generate_inactive_window_string() {
    ...
    echo "${separator_start}#[fg=${PALLETE[white]}]#I${separator_internal}#[fg=${PALLETE[fg_dark]}] #{?window_zoomed_flag,$zoomed_window_icon,}#{=/15/…:pane_title} ${agent_icon}${separator_end}"
}
